...
namespace HeroesReplay
{
    public static class HeroesReplayParserExtensions
    {
        ...
        public static bool IsTimeSpanDiedWithin(this Unit unit, TimeSpan start, TimeSpan end) => unit.TimeSpanDied.HasValue && unit.TimeSpanDied.Value.IsWithin(start, end);
