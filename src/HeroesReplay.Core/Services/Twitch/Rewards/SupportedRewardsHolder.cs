...
namespace HeroesReplay.Core.Services.Twitch
{
    public class SupportedRewardsHolder : ISupportedRewardsHolder
    {
        ...
        private List<SupportedReward> GetRewards()
        {
            ...
            rewards.Add(new SupportedReward(RewardType.UD, "Random (UD)", mode: GameType.Unranked));
            ...
            rewards.AddRange(unrankedMaps.Select(map => new SupportedReward(RewardType.UDMap, $"{map.Name} (UD)", map.Name, mode: GameType.Unranked)));
            ...
            rewards.AddRange(tiers.Select(tier => new SupportedReward(RewardType.UDTier, $"{tier} (UD)", tier: tier, mode: GameType.Unranked)));
            ...
            rewards.AddRange(unrankedMaps.SelectMany(map => tiers.Select(tier => new SupportedReward(RewardType.UDMap, $"{map.Name} (UD)", map.Name, tier: tier, mode: GameType.Unranked))));
